...
Original file is located at
    https://colab.research.google.com/drive/1pXXhe5nqeUHyR8JXhLQqszWaUgsAIF8C
...
for lat, lng, in zip(df_incidents.Y, df_incidents.X):
    incidents.add_child(
        folium.features.CircleForMarker([lat, lng],
...
# Can also add some pop-up text that would get displayed when you hover over a marker. Let's make each marker display the category of the crime when hovered over.
